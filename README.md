...
4. Complete the [Simulated Employee Laptop](#simulated-employee-laptop) section
5. Complete the [Corp Intranet Server Setup (Intranet Device)](#corp-intranet-server-setup-intranet-device) section
